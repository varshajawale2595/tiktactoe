...
<head>
	...
	<body>
		...
		<div class = "container">
			...
			<form action = "<?php echo base_url('Main_Controller/saveResult'); ?>" method = "post", class = "form-horizontal"  align="center">
						...
						<input class = "winner" type = "hidden" name = "winner" id = "winner"></br>
						<input class= "btn btn-default" type="submit" value="Save Game Result" />
