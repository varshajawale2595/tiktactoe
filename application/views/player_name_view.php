		...
		<div class="row">
		   ...
		   <div class="col-md-6">
			...
			<div class = "container">
				...
				<br></br>
				<form action = "<?php echo base_url('Main_Controller/submit'); ?>" method = "post", class = "form-horizontal">
				...
				<form action = "<?php echo base_url('Main_Controller/submitPlayerVsComp'); ?>" method = "post", class = "form-horizontal">
